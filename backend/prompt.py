...
def make_prompt(user: str, char: str, wiBefore: str, description: str, personality: str, scenario: str, wiAfter: str, persona: str, entries: list) -> str:
    ...
    story_string += entries[0].content + instruct["output_suffix"]
